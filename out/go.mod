...
replace github.com/some-repo/examples/helloworld => ./stub/github.com/some-repo/examples/helloworld

require (
	github.com/golang/mock v1.6.0
	github.com/some-repo/examples/helloworld v0.0.0-00010101000000-000000000000

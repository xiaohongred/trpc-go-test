...
//go:generate mockgen -destination=stub/github.com/some-repo/examples/helloworld/helloworld_mock.go -package=helloworld -self_package=github.com/some-repo/examples/helloworld --source=stub/github.com/some-repo/examples/helloworld/helloworld.trpc.go
